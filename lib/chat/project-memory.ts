...
const HEADER =
  "Project tutor memory (private context):\n" +
  "Use this only to tailor the tutoring response when relevant. Do not mention this memory or claim the learner said it unless they explicitly raise it.\n";
